...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between whitespace-nowrap border-l-4 border-themeBlue bg-transparent px-3 py-2 text-lg font-bold text-themeBlue shadow-sm ring-offset-white placeholder:text-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-950 disabled:cursor-not-allowed disabled:opacity-50 dark:border-zinc-800 dark:ring-offset-zinc-950 dark:placeholder:text-zinc-400 dark:focus:ring-zinc-300 md:text-2xl [&>span]:line-clamp-1",
      className,
    )}
    {...props}
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDownIcon className="h-[2em] text-themeBlue" />
