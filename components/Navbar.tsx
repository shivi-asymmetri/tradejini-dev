  ...
  return (
    <>
      <header className={"navbar-root sticky top-0 z-[999999]"}>
        <div className={`relative flex items-center justify-between px-6 py-3 ${isProductsPage ? "bg-black" : "bg-white"}`}>
          ...
          <div className={`hidden items-center lg:flex ${isProductsPage ? "text-white" : ""}`}>
            <Dropdown>
              <TriggerWrapper>
                <Link href={"/products"} className={isProductsPage ? "text-white" : ""}>Products</Link>
                <Link href={"/pricing"} className={isProductsPage ? "text-white" : ""}>Pricing</Link>
                <Link href={"/support"} className={isProductsPage ? "text-white" : ""}>Support</Link>
              </TriggerWrapper>
            </Dropdown>
            <HoverCard
              openDelay={0}
            ...
            >
              ...
              >
                <div className="w-2/5 space-y-3 p-5">
                  <div className={`w-full font-poppins text-sm font-semibold opacity-70 ${isProductsPage ? "text-white" : ""}`}>
                    Top Blogs Category
                  </div>
                ...
                <div className="w-3/5 p-5">
                  ...
                  <div className="flex h-full gap-2">
                    {regularBlogs?.blogs && regularBlogs.blogs.length > 0 ? (
                      regularBlogs.blogs
                        ...
                        .map((blog: BlogType, i: number) => (
                          ...
                          >
                            ...
                            <h2 className={`line-clamp-2 font-poppins text-base font-medium ${isProductsPage ? "text-white" : ""}`}>
                              {blog.title}
                            </h2>
                            <p className={`font-inter text-sm ${isProductsPage ? "text-white/70" : "text-[#1D1D1D80]"}`}>
                              {blog.readingTime}
                            </p>
                            <p className={`font-inter text-sm ${isProductsPage ? "text-white/70" : "text-[#1D1D1D80]"}`}>
                              {blog.author?.name}
                      ...
                      <div className={`w-full py-4 text-center ${isProductsPage ? "text-white/70" : "text-gray-500"}`}>
                        Loading blogs...
                      </div>
                    )}
                  </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Link className="dropdown-heading" href={"/about-us"}>Who we are?</Link>
                  <Link className="dropdown-heading" href={"/products"}>Products</Link>

                  <Link className="dropdown-heading" href="/fundTransfer">Funds</Link>
                  <Link className="dropdown-heading" href={"/pricing"}>Pricing</Link>
                  <Link
                  ...
                  <Link href="/press-coverage" onClick={handlePressCoverageClick}>Press Coverage </Link>
                  ...
                  <Link className="dropdown-heading" href="/calculators">Calculators</Link>
                  <Link className="dropdown-heading" href="/api">Algo Traders</Link>
                  <Link className="dropdown-heading" href="/holiday-page">Holiday Calendar</Link>
                  <Link className="dropdown-heading" href="/chart-speaks">Chart Speaks</Link>
                </div>
                <hr className={isProductsPage ? "border-white/30" : ""} />
                <div
                  onClick={() => {
                ...
                >
                  ...
                  <div className="grid grid-cols-5 place-items-center gap-3 *:h-full">
                    <div className="space-y-4 font-bold">
                      <h4 className="dropdown-heading text-xl font-bold">Trader</h4>
                      <div className={`flex flex-col gap-y-2 ${isProductsPage ? "text-white/70" : "text-black/40"}`}>
                    ...
                    <div className="space-y-4 font-bold">
                      <h4 className="dropdown-heading text-xl font-bold">Investor</h4>
                      <div className={`flex flex-col gap-y-2 ${isProductsPage ? "text-white/70" : "text-black/40"}`}>
                    ...
                    <div className="space-y-4 font-bold">
                      <h4 className="dropdown-heading text-xl font-bold">Learn</h4>
                      <div className={`flex flex-col gap-y-2 ${isProductsPage ? "text-white/70" : "text-black/40"}`}>
                        <Link
                          onClick={() => {
                            handleWebEngage(
                    ...
                    <div className="space-y-4 font-bold">
                      <h4 className="dropdown-heading text-xl font-bold">Quick Links</h4>
                      <div className={`flex flex-col gap-y-2 ${isProductsPage ? "text-white/70" : "text-black/40"}`}>
                    ...
                    <div className="space-y-4 font-bold">
                      <h4 className="dropdown-heading text-xl font-bold">Updates</h4>
                      <div className={`flex flex-col gap-y-2 ${isProductsPage ? "text-white/70" : "text-black/40"}`}>
