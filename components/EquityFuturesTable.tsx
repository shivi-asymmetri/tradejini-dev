...
export default function EquityFuturesTable({
  ...
  const [json, setJson] = useState<EquityFutureData[]>([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const res = await fetch("/api/equity-futures");
        ...
        setError("Failed to load equity futures data. Please try again later.");
        setJson([]);
      } finally {
        setLoading(false);
      }
          ...
          <thead className="sticky left-0 top-0 z-30 rounded-t-3xl border-b-2 border-gray-200 text-[#8b8b8b] dark:text-white/80">
            <tr className="relative rounded-t-3xl font-normal">
              ...
              <th className="font-normal md:min-w-40">
                <p className="bg-[#f6f6f6] py-3 dark:bg-zinc-800">Lot Size</p>
              </th>
              <th className="font-normal md:min-w-40">
                <p className="bg-[#f6f6f6] py-3 dark:bg-zinc-800">Expiry</p>
              </th>
              <th className="font-normal md:min-w-40">
